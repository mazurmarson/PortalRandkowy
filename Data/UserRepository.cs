...
namespace PortalRandkowy.API.Data
{
    public class UserRepository : GenericRepository ,IUserRepository
    {
        ...
        private async Task<IEnumerable<int>> GetUserLikes(int id, bool userLikes)
        {
            ...
            .Include(x => x.UserIsLiked).FirstOrDefaultAsync(u => u.Id == id);
        ...
        public async Task<PagedList<Message>> GetMessagesForUser(MessageParams messageParams)
        {
            ...
            {
                case "Inbox" :
                    messages = messages.Where(u => u.RecipientId == messageParams.UserId && u.RecipientDeletd == false);
                    break;
                ...
                default:
                    messages = messages.Where(u => u.RecipientId == messageParams.UserId && u.IsRead == false && u.RecipientDeletd == false);
                    break;
        ...
        public async Task<IEnumerable<Message>> GetMessageThread(int userId, int recipientId)
        {
            ...
            .Where(m => m.RecipientId == userId && m.SenderId == recipientId && m.RecipientDeletd == false
